...
| **Основний сценарій:** | 1. Користувач відкриває меню опитування <br> 2. Користувач надсилає запит на перегляд інформації про опитування <br> 3. Обробка запиту системою <br> 4. Система надає загальну інформацію: назва, опис, кількість питань, типи питань тощо|
...
| **Основний сценарій:** | 1. Користувач обирає опитування, яке хоче видалити <br> 2. Користувач надсилає запит на видалення опитування <br> 3. Система обробляє запит на видалення  |

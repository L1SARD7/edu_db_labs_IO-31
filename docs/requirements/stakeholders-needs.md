...
| **Виключні ситуації:** |   Опитування триває або користувач не має доступу до опитування                                                                                                                                                                                                                                            |
| **Основний сценарій:** | 1. Користувач обирає опитування, результати якого необхідно експортувати. <br> 2. Користувач надсилає до системи запит на отримання файлу з відповіддю. <br> 3. Система обробляє запит користувача. <br> 4. Система надає посилання для завантаження файлу з відповіддю.
 |

...
* **Вступ**
    * Короткий огляд мети та структури всього документу, що присвячений аналізу предметної області розробки системи для організації та управління опитуваннями експертів, з метою забезпечення веб-доступу до інструментів створення, модифікації, організації та обробки результатів експертних опитувань.
* **Основні визначення**
